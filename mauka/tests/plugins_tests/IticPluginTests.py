...
class IticPluginTests(unittest.TestCase):
    ...
    def test_itic_no_interruptions(self):
        self.assertEqual(IticRegion.NO_INTERRUPTION, plugins.IticPlugin.itic_region(1000, plugins.IticPlugin.c_to_ms(0.01)))
        self.assertEqual(IticRegion.NO_INTERRUPTION, plugins.IticPlugin.itic_region(600, plugins.IticPlugin.c_to_ms(0.01)))
    ...
    def test_itic_prohibited(self):
        self.assertEqual(IticRegion.PROHIBITED, plugins.IticPlugin.itic_region(120*5.00, plugins.IticPlugin.c_to_ms(0.02)))
        self.assertEqual(IticRegion.PROHIBITED, plugins.IticPlugin.itic_region(120*5.01, plugins.IticPlugin.c_to_ms(0.02)))
