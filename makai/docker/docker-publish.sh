...
## Publishes the most recently created Makai image to DockerHub.
...
# Source the Docker-Compose .env file and grab the MAKAI_IMAGE variable.
. ../../util/docker-deployment/.env

DOCKER_SRC_IMAGE=makai:latest
DOCKER_DEST_IMAGE=${MAKAI_IMAGE}
