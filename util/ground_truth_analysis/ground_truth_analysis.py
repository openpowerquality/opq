...
def plot_frequency(opq_start_ts_s: int,
    ...
    min_y = min(frequencies.min(), min(gt_f))
    max_y = max(frequencies.max(), max(gt_f))
    ...
    fig.suptitle(
            f"Frequency Ground Truth Comparison: {opq_box_id} vs {uhm_sensor} {dts[0].strftime('%Y-%m-%d')} to "
...
def plot_avg_voltage_thd(opq_start_ts_s: int,
    ...
    min_y = min(thds.min(), min(gt_thd))
    max_y = max(thds.max(), max(gt_thd))
...
if __name__ == "__main__":
    ...
    # Frequency
    # 1000
    plot_frequency(start_ts_s, end_ts_s, "1000", gt_root, "POST_MAIN_1",
                   mongo_client, ".")
    plot_frequency(start_ts_s, end_ts_s, "1000", gt_root, "POST_MAIN_2",
                   mongo_client, ".")

    # 1001
    # plot_frequency(start_ts_s, end_ts_s, "1001", gt_root, "HAMILTON_LIB_PH_III_CH_1_MTR", mongo_client, ".")
    plot_frequency(start_ts_s, end_ts_s, "1001", gt_root,
    ...
    # 1002
    plot_frequency(start_ts_s, end_ts_s, "1002", gt_root, "POST_MAIN_1",
                   mongo_client, ".")
    plot_frequency(start_ts_s, end_ts_s, "1002", gt_root, "POST_MAIN_2",
                   mongo_client, ".")

    # 1003
    plot_frequency(start_ts_s, end_ts_s, "1003", gt_root, "KELLER_HALL_MAIN_MTR",
                   mongo_client, ".")

    # 1021
    plot_frequency(start_ts_s, end_ts_s, "1021", gt_root,
                   "MARINE_SCIENCE_MAIN_A_MTR", mongo_client, ".")
    plot_frequency(start_ts_s, end_ts_s, "1021", gt_root,
                   "MARINE_SCIENCE_MAIN_B_MTR", mongo_client, ".")
    # plot_frequency(start_ts_s, end_ts_s, "1021", gt_root, "MARINE_SCIENCE_MCC_MTR", mongo_client, ".")

    # 1022
    plot_frequency(start_ts_s, end_ts_s, "1022", gt_root, "AG_ENGINEERING_MAIN_MTR",
                   mongo_client, ".")
    plot_frequency(start_ts_s, end_ts_s, "1022", gt_root, "AG_ENGINEERING_MCC_MTR",
                   mongo_client, ".")

    # 1023
    plot_frequency(start_ts_s, end_ts_s, "1023", gt_root, "LAW_LIB_MAIN_MTR",
                   mongo_client, ".")

    # 1025
    plot_frequency(start_ts_s, end_ts_s, "1025", gt_root, "KENNEDY_THEATRE_MAIN_MTR",
                   mongo_client, ".")
    ...
    # # Thd Incidents
    # # 1000
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1000", gt_root, "POST_MAIN_1",
    #                      mongo_client, ".")
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1000", gt_root, "POST_MAIN_2",
    #                      mongo_client, ".")
    #
    # # 1001
    # # plot_frequency(start_ts_s, end_ts_s, "1001", gt_root, "HAMILTON_LIB_PH_III_CH_1_MTR", mongo_client, ".")
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1001", gt_root,
    #                      "HAMILTON_LIB_PH_III_CH_2_MTR", mongo_client, ".")
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1001", gt_root,
    #                      "HAMILTON_LIB_PH_III_CH_3_MTR", mongo_client, ".")
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1001", gt_root,
    ...
    #
    # # 1002
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1002", gt_root, "POST_MAIN_1",
    #                      mongo_client, ".")
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1002", gt_root, "POST_MAIN_2",
    #                      mongo_client, ".")
    #
    # # 1003
    # # plot_avg_voltage_thd(start_ts_s, end_ts_s, "1003", gt_root, "KELLER_HALL_MAIN_MTR",
    ...
    #
    # # 1021
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1021", gt_root,
    #                      "MARINE_SCIENCE_MAIN_A_MTR", mongo_client, ".")
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1021", gt_root,
    #                      "MARINE_SCIENCE_MAIN_B_MTR", mongo_client, ".")
    # # plot_frequency(start_ts_s, end_ts_s, "1021", gt_root, "MARINE_SCIENCE_MCC_MTR", mongo_client, ".")
    #
    # # 1022
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1022", gt_root, "AG_ENGINEERING_MAIN_MTR",
    #                      mongo_client, ".")
    # plot_avg_voltage_thd_incident(start_ts_s, end_ts_s, "1022", gt_root, "AG_ENGINEERING_MCC_MTR",
    #                      mongo_client, ".")
    #
    # # 1023
    # # plot_avg_voltage_thd(start_ts_s, end_ts_s, "1023", gt_root, "LAW_LIB_MAIN_MTR",
