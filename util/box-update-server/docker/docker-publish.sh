...
## Publishes the most recently created Health image to DockerHub.
...
# Source the Docker-Compose .env file and grab the HEALTH_IMAGE variable.
#. ../../util/docker/.env

DOCKER_SRC_IMAGE=opqboxupdateserver:latest
#DOCKER_DEST_IMAGE=$HEALTH_IMAGE
DOCKER_DEST_IMAGE="openpowerquality/opqboxupdateserver:0.1"
...
and modify the 'UPDATER_IMAGE' variable found in the 'opq/util/docker/.env' file."
