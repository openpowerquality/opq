...
function startupIntegrityCheck() {
  if (Meteor.settings.integrityCheck.enabled) {
    ...
    Meteor.settings.integrityCheck.collections.forEach(name => checkCollection(name, repair, verbose));
  }
}
