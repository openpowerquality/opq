...
The **event_start** and **event_end** fields are unix timestamps (millis) indicating the start and end time of the event.
...
The **start_time** field is a unix timestamp (millis) indicating the moment this OPQBox location was set.
